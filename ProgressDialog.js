...
class ProgressDialog {
  ...
  constructor(title_elem_id, item_elem_id) {
  ...
  addItemRow(item, comments) {
    ...
    new_title_div.innerText = item.name;
    new_title_div.dataset.id = item.id;
    // ダブルクリックイベント
    new_title_div.addEventListener('dblclick', this.div_dblclick_title_handler.bind(this));
   ...
   */
  div_dblclick_title_handler(event) {
    // アイテムのコメントを入力
